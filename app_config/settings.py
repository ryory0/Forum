...
ALLOWED_HOSTS = ['forum-appry-be3dcf92c9d9.herokuapp.com', '127.0.0.1', 'localhost'] # Heroku上のアプリケーションのURLを設定する
...
# 静的ファイルをHerokuの専用ハンドラで配信するための設定
...
AUTH_USER_MODEL = 'app_folder.User'


EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
DEFAULT_FROM_EMAIL = '4romaroot@gmail.com'
EMAIL_HOST_USER = '4romaroot@gmail.com'
